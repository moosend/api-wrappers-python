...
**subject** | **str** | The subject line of the new campaign. | 
**sender_email** | **str** | The sender email of the campaign. | 
**reply_to_email** | **str** | The email address to which recipients replies will arrive. It must be one of your sender accounts. If not specified, the sender&#39;s email will be assumed. | 
**is_ab** | **str** | A flag that defines if a campaign is an AB campaign. | 
