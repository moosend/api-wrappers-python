...
class UpdatingADraftCampaignRequest(object):
    """
    ...
    def __init__(self, name=None, subject=None, sender_email=None, reply_to_email=None, is_ab=None, confirmation_to_email=None, web_location=None, mailing_lists=None, segment_id=None, ab_campaign_type=None, track_in_google_analytics=None, dont_track_link_clicks=None, subject_b=None, web_location_b=None, sender_email_b=None, hours_to_test=None, list_percentage=None, ab_winner_selection_type=None):
        """
        UpdatingADraftCampaignRequest - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this UpdatingADraftCampaignRequest.
        The name of the campaign.

        :return: The name of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this UpdatingADraftCampaignRequest.
        The name of the campaign.

        :param name: The name of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def subject(self):
        """
        Gets the subject of this UpdatingADraftCampaignRequest.
        The subject line of the new campaign.

        :return: The subject of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def subject(self, subject):
        """
        Sets the subject of this UpdatingADraftCampaignRequest.
        The subject line of the new campaign.

        :param subject: The subject of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def sender_email(self):
        """
        Gets the sender_email of this UpdatingADraftCampaignRequest.
        The sender email of the campaign.

        :return: The sender_email of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def sender_email(self, sender_email):
        """
        Sets the sender_email of this UpdatingADraftCampaignRequest.
        The sender email of the campaign.

        :param sender_email: The sender_email of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def reply_to_email(self):
        """
        Gets the reply_to_email of this UpdatingADraftCampaignRequest.
        ...
        :return: The reply_to_email of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def reply_to_email(self, reply_to_email):
        """
        Sets the reply_to_email of this UpdatingADraftCampaignRequest.
        The email address to which recipients replies will arrive. It must be one of your sender accounts. If not specified, the sender's email will be assumed.

        :param reply_to_email: The reply_to_email of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def is_ab(self):
        """
        Gets the is_ab of this UpdatingADraftCampaignRequest.
        A flag that defines if a campaign is an AB campaign.

        :return: The is_ab of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
        return self._is_ab
    ...
    def is_ab(self, is_ab):
        """
        Sets the is_ab of this UpdatingADraftCampaignRequest.
        A flag that defines if a campaign is an AB campaign.

        :param is_ab: The is_ab of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def confirmation_to_email(self):
        """
        Gets the confirmation_to_email of this UpdatingADraftCampaignRequest.
        The email address to which a confirmation message will be,  sent when the campaign has been successfully sent.

        :return: The confirmation_to_email of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def confirmation_to_email(self, confirmation_to_email):
        """
        Sets the confirmation_to_email of this UpdatingADraftCampaignRequest.
        The email address to which a confirmation message will be,  sent when the campaign has been successfully sent.

        :param confirmation_to_email: The confirmation_to_email of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def web_location(self):
        """
        Gets the web_location of this UpdatingADraftCampaignRequest.
        A url to retrieve the html content for the campaign. We'll automatically move all CSS inline.

        :return: The web_location of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def web_location(self, web_location):
        """
        Sets the web_location of this UpdatingADraftCampaignRequest.
        A url to retrieve the html content for the campaign. We'll automatically move all CSS inline.

        :param web_location: The web_location of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def mailing_lists(self):
        """
        Gets the mailing_lists of this UpdatingADraftCampaignRequest.
        A list of mailing lists in your account to which the campaign will be sent to.

        :return: The mailing_lists of this UpdatingADraftCampaignRequest.
    ...
    def mailing_lists(self, mailing_lists):
        """
        Sets the mailing_lists of this UpdatingADraftCampaignRequest.
        A list of mailing lists in your account to which the campaign will be sent to.

        :param mailing_lists: The mailing_lists of this UpdatingADraftCampaignRequest.
    ...
    def segment_id(self):
        """
        Gets the segment_id of this UpdatingADraftCampaignRequest.
        ...
        :return: The segment_id of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def segment_id(self, segment_id):
        """
        Sets the segment_id of this UpdatingADraftCampaignRequest.
        The ID of a segment in the specified mailing list to filter the recipients with. If not specified, the campaign will be sent to all active subscribers of the mailing list.

        :param segment_id: The segment_id of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def ab_campaign_type(self):
        """
        Gets the ab_campaign_type of this UpdatingADraftCampaignRequest.
        ...
        :return: The ab_campaign_type of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def ab_campaign_type(self, ab_campaign_type):
        """
        Sets the ab_campaign_type of this UpdatingADraftCampaignRequest.
        If you want to send an AB split campaign you should specify this parameter to one of the following values.  * `Subject` * `Sender` * `Content`

        :param ab_campaign_type: The ab_campaign_type of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def track_in_google_analytics(self):
        """
        Gets the track_in_google_analytics of this UpdatingADraftCampaignRequest.
        ...
        :return: The track_in_google_analytics of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def track_in_google_analytics(self, track_in_google_analytics):
        """
        Sets the track_in_google_analytics of this UpdatingADraftCampaignRequest.
        Tracks traffic from your campaign to your site. Note: You need to have Google Analytics configured on your site to use this feature.

        :param track_in_google_analytics: The track_in_google_analytics of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def dont_track_link_clicks(self):
        """
        Gets the dont_track_link_clicks of this UpdatingADraftCampaignRequest.
        ...
        :return: The dont_track_link_clicks of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def dont_track_link_clicks(self, dont_track_link_clicks):
        """
        Sets the dont_track_link_clicks of this UpdatingADraftCampaignRequest.
        Moosend wraps your own links with its own to enable link click tracking. Check this box if you don't wish to track link click traffic through Moosend.

        :param dont_track_link_clicks: The dont_track_link_clicks of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def subject_b(self):
        """
        Gets the subject_b of this UpdatingADraftCampaignRequest.
        ...
        :return: The subject_b of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def subject_b(self, subject_b):
        """
        Sets the subject_b of this UpdatingADraftCampaignRequest.
        If you wish to send an AB split campaign with two different versions of the subject line , you must specify the second subject using this parameter. If specified in any other campaign type, it will be ignored.

        :param subject_b: The subject_b of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def web_location_b(self):
        """
        Gets the web_location_b of this UpdatingADraftCampaignRequest.
        ...
        :return: The web_location_b of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def web_location_b(self, web_location_b):
        """
        Sets the web_location_b of this UpdatingADraftCampaignRequest.
        If you wish to send an AB split campaign with two different versions of the html content, you must specify where the second html content will be retrieved from using this parameter. If specified in any other campaign type, it will be ignored.

        :param web_location_b: The web_location_b of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def sender_email_b(self):
        """
        Gets the sender_email_b of this UpdatingADraftCampaignRequest.
        ...
        :return: The sender_email_b of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def sender_email_b(self, sender_email_b):
        """
        Sets the sender_email_b of this UpdatingADraftCampaignRequest.
        If you wish to send an AB split campaign with two different versions of the sender , you must specify the second sender email address using this parameter. This must be one of your sender signatures defined in your account. If specified in any other campaign type, it will be ignored.

        :param sender_email_b: The sender_email_b of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def hours_to_test(self):
        """
        Gets the hours_to_test of this UpdatingADraftCampaignRequest.
        ...
        :return: The hours_to_test of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def hours_to_test(self, hours_to_test):
        """
        Sets the hours_to_test of this UpdatingADraftCampaignRequest.
        If you choose to send an AB campaign type, you must set this parameter to specify how long the test will run, before determining which will be the winning version to be sent to the rest of the recipients. This should be an integer value between 1 and 24. If specified in a regular campaign, it will be ignored.

        :param hours_to_test: The hours_to_test of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def list_percentage(self):
        """
        Gets the list_percentage of this UpdatingADraftCampaignRequest.
        ...
        :return: The list_percentage of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def list_percentage(self, list_percentage):
        """
        Sets the list_percentage of this UpdatingADraftCampaignRequest.
        If you choose to send an AB campaign type, you must set this parameter to specify a portion of the target recipients that will receive the test versions. For example, if you specify 10, then 10% of your recipients will receive the A version and another 10% will receive the B version. The specified value should be an integer between 5 and 40. If specified in a regular campaign, it will be ignored. (optional, string)

        :param list_percentage: The list_percentage of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def ab_winner_selection_type(self):
        """
        Gets the ab_winner_selection_type of this UpdatingADraftCampaignRequest.
        ...
        :return: The ab_winner_selection_type of this UpdatingADraftCampaignRequest.
        :rtype: str
        """
    ...
    def ab_winner_selection_type(self, ab_winner_selection_type):
        """
        Sets the ab_winner_selection_type of this UpdatingADraftCampaignRequest.
        If you choose to send an AB campaign type, you may set this parameter to one of the following values to specify the method to determine the winning version for the test.   If not set, OpenRate will be assumed. If specified in a regular campaign, it will be ignored. * `OpenRate` * `TotalUniqueClicks`

        :param ab_winner_selection_type: The ab_winner_selection_type of this UpdatingADraftCampaignRequest.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UpdatingADraftCampaignRequest):
            return False
